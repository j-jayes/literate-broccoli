...
## Copilot Studio: Great for 1:1, Not for Group Polls 🙅
...
## 🍔 Demo {background-gradient="linear-gradient(135deg, #190878 0%, #5a1ea0 52%, #aa4bf5 100%)"}
...
## MCP Has Broad Ecosystem Support 🌍

::: {.statement}
Supported by Claude, ChatGPT, VS Code, Cursor, and many more.
:::

::: {.incremental}

- Define your tool once with input and output schemas
- Expose it over HTTP or stdio
- Any MCP-compatible client can call it
- No custom integration code per consumer

:::

<!-- IMAGE: You can add an ecosystem logos graphic here. Save to assets/screenshots/mcp-ecosystem.png and use: ![](assets/screenshots/mcp-ecosystem.png) -->
